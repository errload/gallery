        ...
        <?php if (isset($_SESSION['login'])): ?>
            <div class="addComment">
                <form action="" id="commentForm">
                    <textarea name="comment" class="textarea" placeholder="your comment"></textarea> <br/>
                    <input type="hidden" name="hiddenId" class="hidden" value="" />
                    <input type="submit" class="commentbtn" value="send" />
                </form>
            </div>
        <?php endif; ?>
    </div>
        ...
        <?php if (isset($_SESSION['login'])): ?>
            <div class="upload__form">
                <form action="" id="uploadForm">
                    <label for="uploadFile" class="uploadFile"> upload </label>
